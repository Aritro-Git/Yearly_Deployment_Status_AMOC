...
st.markdown("<h2 style='text-align: center; color: white;'><u>August Deployment Status LOB Wise</h2>", unsafe_allow_html=True)
...
if selected == "Completed":
    ...
    filter_value_month_completed = "August"
...
if selected == "Partially deployed":
    ...
    filter_value_month_Partially_deployed = "August"
...
if selected == "Cancelled":
    ...
    filter_value_month_Canc = "August"
...
if selected == "Cancelled/Rescheduled":
    ...
    filter_value_month_CancResc = "August"
...
if selected == "Backed Out":
    ...
    filter_value_month_BackedOut = "August"
...
if selected == "Unsuccessful":
    ...
    filter_value_month_Unsuccessful = "August"
