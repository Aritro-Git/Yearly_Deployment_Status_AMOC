...
st.markdown("<h2 style='text-align: center; color: white;'><u>April Deployment Status LOB Wise</h2>", unsafe_allow_html=True)
...
if selected == "Completed":
    ...
    filter_value_month_completed = "April"
...
if selected == "Partially deployed":
    ...
    filter_value_month_Partially_deployed = "April"
...
if selected == "Cancelled/Rescheduled":
    ...
    filter_value_month_CancResc = "April"
...
if selected == "Backed Out":
    ...
    filter_value_month_BackedOut = "April"
...
if selected == "Unsuccessful":
    ...
    filter_value_month_Unsuccessful = "April"
