...
st.markdown("<h2 style='text-align: center; color: white;'><u>December Deployment Status LOB Wise</h2>", unsafe_allow_html=True)
...
if selected == "Completed":
    ...
    filter_value_month_completed = "December"
...
if selected == "Partially deployed":
    ...
    filter_value_month_Partially_deployed = "December"
...
if selected == "Cancelled":
    ...
    filter_value_month_Canc = "December"
...
if selected == "Cancelled/Rescheduled":
    ...
    filter_value_month_CancResc = "December"
...
if selected == "Backed Out":
    ...
    filter_value_month_BackedOut = "December"
...
if selected == "Unsuccessful":
    ...
    filter_value_month_Unsuccessful = "December"
