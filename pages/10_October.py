...
st.markdown("<h2 style='text-align: center; color: white;'><u>October Deployment Status LOB Wise</h2>", unsafe_allow_html=True)
...
if selected == "Completed":
    ...
    filter_value_month_completed = "October"
...
if selected == "Partially deployed":
    ...
    filter_value_month_Partially_deployed = "October"
...
if selected == "Cancelled":
    ...
    filter_value_month_Canc = "October"
...
if selected == "Cancelled/Rescheduled":
    ...
    filter_value_month_CancResc = "October"
...
if selected == "Backed Out":
    ...
    filter_value_month_BackedOut = "October"
...
if selected == "Unsuccessful":
    ...
    filter_value_month_Unsuccessful = "October"
