...
st.markdown("<h2 style='text-align: center; color: white;'><u>June Deployment Status LOB Wise</h2>", unsafe_allow_html=True)
...
if selected == "Completed":
    ...
    filter_value_month_completed = "June"
...
if selected == "Partially deployed":
    ...
    filter_value_month_Partially_deployed = "June"
...
if selected == "Cancelled/Rescheduled":
    ...
    filter_value_month_CancResc = "June"
...
if selected == "Backed Out":
    ...
    filter_value_month_BackedOut = "June"
...
if selected == "Unsuccessful":
    ...
    filter_value_month_Unsuccessful = "June"
