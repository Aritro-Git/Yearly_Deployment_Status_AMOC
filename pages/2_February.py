...
st.markdown("<h2 style='text-align: center; color: white;'><u>February Deployment Status LOB Wise</h2>", unsafe_allow_html=True)
...
if selected == "Completed":
    ...
    filter_value_month_completed = "February"
...
if selected == "Partially deployed":
    ...
    filter_value_month_Partially_deployed = "February"
...
if selected == "Cancelled":
    ...
    filter_value_month_Canc = "February"
...
if selected == "Cancelled/Rescheduled":
    ...
    filter_value_month_CancResc = "February"
...
if selected == "Backed Out":
    ...
    filter_value_month_BackedOut = "February"
...
if selected == "Unsuccessful":
    ...
    filter_value_month_Unsuccessful = "February"
