...
st.markdown("<h2 style='text-align: center; color: white;'><u>May Deployment Status LOB Wise</h2>", unsafe_allow_html=True)
...
if selected == "Completed":
    ...
    filter_value_month_completed = "May"
...
if selected == "Partially deployed":
    ...
    filter_value_month_Partially_deployed = "May"
...
if selected == "Cancelled/Rescheduled":
    ...
    filter_value_month_CancResc = "May"
...
if selected == "Backed Out":
    ...
    filter_value_month_BackedOut = "May"
...
if selected == "Unsuccessful":
    ...
    filter_value_month_Unsuccessful = "May"
