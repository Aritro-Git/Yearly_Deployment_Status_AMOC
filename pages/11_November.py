...
st.markdown("<h2 style='text-align: center; color: white;'><u>November Deployment Status LOB Wise</h2>", unsafe_allow_html=True)
...
if selected == "Completed":
    ...
    filter_value_month_completed = "November"
...
if selected == "Partially deployed":
    ...
    filter_value_month_Partially_deployed = "November"
...
if selected == "Cancelled":
    ...
    filter_value_month_Canc = "November"
...
if selected == "Cancelled/Rescheduled":
    ...
    filter_value_month_CancResc = "November"
...
if selected == "Backed Out":
    ...
    filter_value_month_BackedOut = "November"
...
if selected == "Unsuccessful":
    ...
    filter_value_month_Unsuccessful = "November"
