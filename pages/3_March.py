...
st.markdown("<h2 style='text-align: center; color: white;'><u>March Deployment Status LOB Wise</h2>", unsafe_allow_html=True)
...
if selected == "Completed":
    ...
    filter_value_month_completed = "March"
...
if selected == "Partially deployed":
    ...
    filter_value_month_Partially_deployed = "March"
...
if selected == "Cancelled/Rescheduled":
    ...
    filter_value_month_CancResc = "March"
...
if selected == "Backed Out":
    ...
    filter_value_month_BackedOut = "March"
...
if selected == "Unsuccessful":
    ...
    filter_value_month_Unsuccessful = "March"
