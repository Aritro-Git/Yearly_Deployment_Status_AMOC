...
st.markdown("<h2 style='text-align: center; color: white;'><u>July Deployment Status LOB Wise</h2>", unsafe_allow_html=True)
...
if selected == "Completed":
    ...
    filter_value_month_completed = "July"
...
if selected == "Partially deployed":
    ...
    filter_value_month_Partially_deployed = "July"
...
if selected == "Cancelled/Rescheduled":
    ...
    filter_value_month_CancResc = "July"
...
if selected == "Backed Out":
    ...
    filter_value_month_BackedOut = "July"
...
if selected == "Unsuccessful":
    ...
    filter_value_month_Unsuccessful = "July"
